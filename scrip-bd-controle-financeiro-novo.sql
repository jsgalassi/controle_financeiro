...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`banco` (
  ...
  `nrobanco` VARCHAR(10) NULL DEFAULT NULL,
  `razaosocial` VARCHAR(150) NULL DEFAULT NULL,
  `nomefantasia` VARCHAR(150) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`cliente` (
  ...
  `nomecliente` VARCHAR(150) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`contabanco` (
  ...
  `nroagencia` VARCHAR(150) NULL DEFAULT NULL,
  `natconta` VARCHAR(20) NULL DEFAULT NULL,
  `nroconta` VARCHAR(45) NULL DEFAULT NULL,
  `tipooperacao` VARCHAR(11) NULL DEFAULT NULL,
  `codbanco` INT(11) NOT NULL,
  `codcliente` INT(11) NOT NULL,
  PRIMARY KEY (`idconta`),
  INDEX `idx_contabanco_banco` (`codbanco` ASC),
  INDEX `idx_contabanco_cliente` (`codcliente` ASC),
  CONSTRAINT `fk_contabanco_banco`
    FOREIGN KEY (`codbanco`)
    REFERENCES `controle_financeiro`.`banco` (`codbanco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_contabanco_cliente`
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`grupoconta` (
  ...
  `nomegrupo` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`modulo` (
  ...
  `desmodulo` VARCHAR(20) NULL DEFAULT NULL,
  `urlmodulo` VARCHAR(500) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`tipoperacao` (
  `codop` INT(11) NOT NULL AUTO_INCREMENT,
  `descop` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`codop`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`tipoconta` (
  ...
  `nomeconta` VARCHAR(45) NULL DEFAULT NULL,
  `tipocontacol` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`movimentacao` (
  `codmov` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `controle_financeiro`.`usuario` (
  ...
  `nomeusuario` VARCHAR(10) NULL DEFAULT NULL,
